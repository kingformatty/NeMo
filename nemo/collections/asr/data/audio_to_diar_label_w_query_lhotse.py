    ...
    def __getitem__(self, cuts) -> Tuple[torch.Tensor, ...]:
        ...
        if self.add_separater_audio:
            ...
            for i in range(len(audio)):
                ...
                #separater -> query -> audio
                # concat_list.append(torch.cat([torch.tensor(self.separater_audio).to(audio.dtype),query_audio[i,:query_audio_lens[i]],audio[i,:audio_lens[i]]]))
